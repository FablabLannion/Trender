...
uint8_t TDR_NeoPixel::setup() {
 ...
 // _ptk->attach(0.05,tkTDR_NeoPixelColor,this);
  ...
  this->gotoColor(0xFFFFFF,5);
  this->gotoColor(0x000000,5);

	return TDR_SUCCESS;
}

uint8_t TDR_NeoPixel::showError() {
  for(int i=0;i<3;i++) {
    setColor(0xFF0000);
    delay(300);
    setColor(0x000000);
...
uint8_t TDR_NeoPixel::showOK() {
  setColor(0x000000);
  gotoColor(0x00FF00,5);
  gotoColor(0x000000,5);
  return TDR_SUCCESS;
}
uint8_t TDR_NeoPixel::showChangeMode() {
  for(int i=0;i<3;i++) {
    setColor(0x00FF00);
    delay(300);
    setColor(0x000000);
